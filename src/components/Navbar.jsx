      ...
      <div className="max-w-7xl mx-auto px-6 py-4">
        <div className="flex items-center justify-between">
          ...
          <motion.a
            ...
            whileTap={{ scale: 0.95 }}
            className="text-3xl font-bold text-[#b8860b] tracking-widest"
          >
            JAGUAR
          </motion.a>
              ...
              <div className="py-4 space-y-4">
                {navItems.map((item) => (
                  <a
                    ...
                    className="block text-white text-sm uppercase tracking-wider hover:text-[#d4a517] transition-colors duration-300"
                  >
                    {item.name}
                  </a>
                ))}
